...
const IndexPage = () => (
  <Layout>
    ...
    <p>We see online participation as a mode of cultural activity.  We thin k social media can be something other than the consumption of leisure time, or the manipulation of of ones friends and networks. In other words: we abhor dating apps.</p>
